...
// Query: *[_type=="startup" && _id == $startupId][0] {  _id,   title,   slug,   _createdAt,   author -> {    _id, name, username, slug, image, bio  },  views,   description,  category,   image,  pitch}
...
// Variable: VIEWS_BY_ID_QUERY
// Query: *[_type=="startup" && _id == $startupId][0] {  _id,  views, }
export type VIEWS_BY_ID_QUERYResult = {
	_id: string;
	views: number | null;
} | null;
// Variable: AUTHOR_BY_ID_QUERY
// Query: *[_type=="author" && id == $authorId][0] {  _id,   name,   username,   email,   image,   bio}
